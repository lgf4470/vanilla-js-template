...
const { createHub } = require('../modules/apihub/service');
const authRoutes = require('../modules/auth/routes');
const settingsRoutes = require('../modules/settings/routes');
const hubRoutes = require('../modules/apihub/routes');
