...
(function () {
  ...
  /* 确定性头像底色(按名称 hash 取色) */
  var AVATAR_COLORS = [
    'var(--nova-palette-red)',
    'var(--nova-palette-orange)',
    'var(--nova-palette-yellow)',
    'var(--nova-palette-green)',
    'var(--nova-palette-cyan)',
    'var(--nova-palette-blue)',
    'var(--nova-palette-violet)',
    'var(--nova-palette-pink)',
  ];
