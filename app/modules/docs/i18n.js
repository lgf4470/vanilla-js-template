...
window.__moduleI18n['docs'] = {
  en: {
    ...
    'docs.introduction.l1':
      'app/core/ — core runtime: boot, router, settings, i18n, UI kit, App Shell',
    'docs.introduction.l2':
      'app/modules/ — business modules: one directory per top-level sidebar menu',
    'docs.introduction.l3':
      'app/styles/ — design system (vendored build output, all styles & palettes)',
    'docs.introduction.l4': 'app/fonts/ — local fonts, zero CDN requests',
    ...
    'docs.getStarted.step1': 'Create the directory app/modules/<name>/',
    'docs.getStarted.step2':
      'Write manifest.js (metadata) + i18n.js (module dictionary) + module.js (implementation)',
    'docs.getStarted.step3': 'Add one import() entry to app/modules/registry.js',
  ...
  'zh-CN': {
    ...
    'docs.introduction.l1': 'app/core/ — 核心运行时:引导、路由、设置、i18n、UI 组件、App Shell',
    'docs.introduction.l2': 'app/modules/ — 业务模块:侧边栏每个一级菜单对应一个目录',
    'docs.introduction.l3': 'app/styles/ — 设计系统(内置编译产物,含全部风格与调色板)',
    'docs.introduction.l4': 'app/fonts/ — 本地字体,零 CDN 请求',
    ...
    'docs.getStarted.step1': '创建目录 app/modules/<name>/',
    'docs.getStarted.step2': '编写 manifest.js(元信息)+ i18n.js(模块词典)+ module.js(实现)',
    'docs.getStarted.step3': '在 app/modules/registry.js 中新增一行 import() 登记',
  ...
  'zh-TW': {
    ...
    'docs.introduction.l1': 'app/core/ — 核心執行時:引導、路由、設定、i18n、UI 元件、App Shell',
    'docs.introduction.l2': 'app/modules/ — 業務模組:側邊欄每個一級選單對應一個目錄',
    'docs.introduction.l3': 'app/styles/ — 設計系統(內置建置產物,含全部風格與調色板)',
    'docs.introduction.l4': 'app/fonts/ — 本機字型,零 CDN 請求',
    ...
    'docs.getStarted.step1': '建立目錄 app/modules/<name>/',
    'docs.getStarted.step2': '編寫 manifest.js(元資訊)+ i18n.js(模組辭典)+ module.js(實作)',
    'docs.getStarted.step3': '在 app/modules/registry.js 中新增一行 import() 登記',
