...
(function () {
  ...
  var dict = {
    en: {
      ...
      'dataTable.view': 'View',
      'dataTable.toggleCols': 'Toggle columns',
      'dataTable.sortDefault': 'Default',
      'dataTable.sortAsc': 'Ascending',
      'dataTable.sortDesc': 'Descending',
      'dataTable.sortHide': 'Hide',
      'dataTable.filterToggle': 'Filter',
      'dataTable.toggleFilters': 'Toggle filters',
      'dataTable.clearFilters': 'Clear filters',
      'dataTable.noFilterResults': 'No results found',
      'dataTable.rowsPerPage': 'Rows per page',
      'dataTable.pageOf': 'Page {n}',
      'dataTable.firstPage': 'First page',
      'dataTable.lastPage': 'Last page',
      'dataTable.nextPage': 'Next page',
      'dataTable.prevPage': 'Previous page',
      'dataTable.goToPage': 'Go to page {n}',
      'dataTable.reset': 'Reset',
      'dataTable.clearSelection': 'Clear selection',
      'dataTable.selectedOne': '1 selected',
      'dataTable.selectedMany': '{n} selected',
      ...
      'settings.useBase': 'Use base color',
      'settings.useAccent': 'Use accent color',
    ...
    'zh-CN': {
      ...
      'dataTable.view': '视图',
      'dataTable.toggleCols': '切换列',
      'dataTable.sortDefault': '默认',
      'dataTable.sortAsc': '升序',
      'dataTable.sortDesc': '降序',
      'dataTable.sortHide': '隐藏',
      'dataTable.filterToggle': '过滤',
      'dataTable.toggleFilters': '切换过滤器',
      'dataTable.clearFilters': '清除过滤',
      'dataTable.noFilterResults': '无匹配项',
      'dataTable.rowsPerPage': '每页行数',
      'dataTable.pageOf': '第 {n} 页',
      'dataTable.firstPage': '第一页',
      'dataTable.lastPage': '最后一页',
      'dataTable.nextPage': '下一页',
      'dataTable.prevPage': '上一页',
      'dataTable.goToPage': '转到第 {n} 页',
      'dataTable.reset': '重置',
      'dataTable.clearSelection': '取消全选',
      'dataTable.selectedOne': '已选 1 项',
      'dataTable.selectedMany': '已选 {n} 项',
      'dataTable.noResults': '无结果',
      ...
      'settings.useBase': '使用基础色',
      'settings.useAccent': '使用强调色',
    ...
    'zh-TW': {
      ...
      'sidebar.signOut': '登出',
      'dataTable.view': '檢視',
      'dataTable.toggleCols': '切換欄位',
      'dataTable.sortDefault': '預設',
      'dataTable.sortAsc': '升序',
      'dataTable.sortDesc': '降序',
      'dataTable.sortHide': '隱藏',
      'dataTable.filterToggle': '篩選',
      'dataTable.toggleFilters': '切換篩選器',
      'dataTable.clearFilters': '清除篩選',
      'dataTable.noFilterResults': '無符合項目',
      'dataTable.rowsPerPage': '每頁行數',
      'dataTable.pageOf': '第 {n} 頁',
      'dataTable.firstPage': '第一頁',
      'dataTable.lastPage': '最後一頁',
      'dataTable.nextPage': '下一頁',
      'dataTable.prevPage': '上一頁',
      'dataTable.goToPage': '轉到第 {n} 頁',
      'dataTable.reset': '重設',
      'dataTable.clearSelection': '取消全選',
      'dataTable.selectedOne': '已選 1 項',
      'dataTable.selectedMany': '已選 {n} 項',
      'dataTable.noResults': '無結果',
      ...
      'settings.useBase': '使用基礎色',
      'settings.useAccent': '使用強調色',
